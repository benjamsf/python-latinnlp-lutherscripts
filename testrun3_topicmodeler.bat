...
lutherscripts-cli -o topic_modeling -1 2 -2 20 -s lutherscripts/txt/habibicorpus_corpus.mm -dc lutherscripts/txt/habibicorpus_dictionary.pkl -d lutherscripts/txt/topictest.json
